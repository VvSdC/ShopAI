...
analyticsRouter.get('/system-health', isLoggedIn, isAdmin, getSystemHealthCtrl)
analyticsRouter.get('/errors', isLoggedIn, isAdmin, getRecentErrorsCtrl)
analyticsRouter.get('/pricing', isLoggedIn, isAdmin, getPricingCtrl)
