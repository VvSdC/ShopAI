            ...
            <form onSubmit={onSubmitHandler} className="space-y-4">
              <div>
                ...
                <div className="relative group">
                  ...
                  <input name="fullname" value={fullname} onChange={onChangeHandler} className="w-full pl-12 pr-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 focus:bg-white transition-all duration-300" type="text" placeholder="Enter your full name" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input name="email" value={email} onChange={onChangeHandler} className="w-full pl-12 pr-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 focus:bg-white transition-all duration-300" type="email" placeholder="name@example.com" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input name="password" value={password} onChange={onChangeHandler} className="w-full pl-12 pr-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 focus:bg-white transition-all duration-300" type="password" placeholder="Create a strong password" />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input name="phone" value={phone} onChange={onChangeHandler} className="w-full pl-12 pr-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 focus:bg-white transition-all duration-300" type="tel" placeholder="+91 98765 43210" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input name="country" value={country} onChange={onChangeHandler} className="w-full pl-12 pr-4 py-3 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 focus:bg-white transition-all duration-300" type="text" placeholder="India" />
                  </div>
                </div>
              </div>

              <label className="flex items-start cursor-pointer group">
                <input type="checkbox" className="mt-1 w-4 h-4 rounded-lg border-gray-300 text-violet-600 focus:ring-violet-500/20 cursor-pointer" />
